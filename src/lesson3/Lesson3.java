...
public class Lesson3 {
    ...
    /**
     * Repeatedly generate results using a Supplier to eliminate some of the issues of running a micro-benchmark.
     *
     * @param <T>
    ...
    /**
     * Computes the Levenshtein distance between every pair of words in the subset, and returns a matrix of distances.
     * This actually computes twice as much as it needs to, since for every word a, b it should be the case that
    ...
    static int[][] computeLevenshtein(List<String> wordList, boolean parallel) {
        ...
        // YOUR CODE HERE
        IntStream stream = IntStream.range(0, LIST_SIZE*LIST_SIZE);

        if (parallel) {
            stream = stream.parallel(); 
        }

        stream.mapToObj(n -> new int[] {n / LIST_SIZE, n % LIST_SIZE})
