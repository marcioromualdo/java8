...
public class RandomWords {
    ...
    private static final String FILE_PATH = "C:\\Users\\marsilva\\git\\java8\\src\\lesson3\\";
    ...
    public RandomWords() throws IOException {
        try (BufferedReader reader = Files.newBufferedReader(Paths.get(FILE_PATH + "words"))) {
